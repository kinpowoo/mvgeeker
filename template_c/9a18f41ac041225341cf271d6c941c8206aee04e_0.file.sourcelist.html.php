<?php
/* Smarty version 3.1.30, created on 2018-07-29 01:20:32
  from "/Users/kinpowoo/Downloads/MVC/tpl/back/sourcelist.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b5ca5e0956064_17687832',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9a18f41ac041225341cf271d6c941c8206aee04e' => 
    array (
      0 => '/Users/kinpowoo/Downloads/MVC/tpl/back/sourcelist.html',
      1 => 1532637168,
      2 => 'file',
    ),
  ),
...
function content_5b5ca5e0956064_17687832 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
，欢迎回来~</p>
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin.php?controller=admin">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">资源管理列表</a></article>
		</div>
...
?>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">资源管理列表</h3>
		</header>
...
?>
	   ...
	   <center>
			<div>
			<a href='index.php?controller=admin&method=sourcelist&t=s&pagenum=1'>首页</a>
			<a href='index.php?controller=admin&method=sourcelist&t=s&pagenum=<?php if ($_smarty_tpl->tpl_vars['pagenum']->value == 1) {?>1<?php } else {
echo $_smarty_tpl->tpl_vars['pagenum']->value-1;
			...
			<a href='index.php?controller=admin&method=sourcelist&t=s&pagenum=<?php if ($_smarty_tpl->tpl_vars['pagenum']->value == $_smarty_tpl->tpl_vars['endpage']->value) {
echo $_smarty_tpl->tpl_vars['endpage']->value;
} else {
echo $_smarty_tpl->tpl_vars['pagenum']->value+1;
}?>'>下一页</a>
			<a href='index.php?controller=admin&method=sourcelist&t=s&pagenum=<?php echo $_smarty_tpl->tpl_vars['endpage']->value;?>
'>尾页</a>
			</div>
 ...
 type="text/javascript">
	function goto(a){
      ...
      if(target_page>a){
       ...
       window.location.href="index.php?controller=admin&method=sourcelist&t=s&pagenum="+target_page;
	}
